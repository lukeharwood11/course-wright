...
const AccountTypeButton = ({ onClick, children, selected, target, ignore, disabled}) => {
    ...
    const className = {
        reg: `${selected === target && !ignore ? "border border-gray-600 bg-blue-300 text-gray-200" : "bg-white text-indigo-500"} flex justify-center items-center logo m-2 p-5 rounded-lg text-3xl`,
