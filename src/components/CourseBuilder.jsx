...
export const CourseBuilder = () => {
    ...
    return (
        <div className="p-3 mt-3 rounded-md w-1/2 bg-gray-100 flex items-center justify-center flex-col">
...
const CourseElement = ({onDelete, onSave}) => {
    ...
    if (!editMode) {
        return (
            <div className="w-full" onDoubleClick={() => setEditMode(true)}>
                <div>
                    <p>
                        {text}
                    </p>
    ...
    return (
        <div className="flex items-center flex-col w-full">
            ...
            <div className="button-bar">
                ...
                <button onClick={onDelete} className="border border-black font-semibold transition-colors hover:bg-white hover:text-red-500 w-40 h-10 rounded-md m-2 px-4 py-2 bg-red-500 text-white">Delete</button>
                <button onClick={() => {
                    onSave()
                    if (text.trim() !== "") {
                        setEditMode(false)
